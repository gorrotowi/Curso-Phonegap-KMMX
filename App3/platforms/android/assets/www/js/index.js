...
var app = {
    ...
    receivedEvent: function(id) {
        ...
        var onSuccesWatch = function(info){
            var data = "latitud: "+ info.coords.latitude+ "\n"+
                "altitud: "+ info.coords.altitude+ "\n"+
                "longitud: "+ info.coords.longitude+ "\n";
            document.getElementById('dataPositionWatch').innerHTML = data;
        }
        ...
        setInterval(navigator.geolocation.watchPosition(onSuccesWatch, onError, {timeout:3000}), 5000)
//        navigator.geolocation.watchPosition(onSuccesWatch, onError, {timeout:3000});
    }
};
